...
ui-router 特别强大，看了主创的youtube和slides
http://slides.com/timkindberg/ui-router
https://www.youtube.com/watch?v=dqJRoh8MnBo#t=2394

笔记的点：
从Evernote中，和slide中copy下

### Demo
自己想些复杂的 app structure， 看看 ui-router 如何很好的解决它

充分理解multi-view(并且可以通过name来定位到任何partial view)，实现类似的block refine(append, replace, prepend)之类的，不通过directive。

充分理解hierarch nested states, 把多个子view的逻辑抽象到共同父view上。并且有onExit, onEnter之类的销毁
